...
/**
 * 프로그램 타임라인 — 세로 타임라인. 베이스 노트의 깊은 톤 위에서.
 */
    ...
    >
      <div className="relative z-10 mx-auto max-w-2xl">
        <Reveal className="text-center">
          ...
          <h2 className="font-serif text-3xl text-cream sm:text-4xl">그날의 흐름</h2>
          <p className="mt-4 text-sm text-cream/60">한 곡의 세트리스트처럼, 차곡차곡 쌓이는 두 시간</p>
          ...
          {TIMELINE.map((item, i) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-baseline gap-3">
                ...
                <h3 className="font-serif text-xl text-cream sm:text-2xl">{item.title}</h3>
              </div>
