                ...
                <div className="relative aspect-[4/3] overflow-hidden border border-ink/20 bg-cream/70 shadow-[0_18px_44px_-30px_rgba(18,17,16,0.5)]">
                  {photo.image ? (
                    ...
                    <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
                      ...
                      <span className="relative text-xs font-medium text-graphite">
                        장소 사진 준비 중
                      </span>
                    </div>
                  )}
                </div>
                <figcaption className="mt-3 flex items-start gap-2 text-sm leading-relaxed text-graphite/85">
                  <span className="mt-1.5 inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-marigold" />
                  {photo.caption}
                </figcaption>
              </figure>
            </Reveal>
